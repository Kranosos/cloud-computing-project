...
Write-Host "[1/4] Deploying project code to both VMs via Git..."
...
Write-Host "[2/4] Uploading video to Edge VM and effect to Cloud VM..."
...
Write-Host "[3/4] Starting video processing on the Edge VM..."
...
Write-Host "[4/4] Transferring keyframes and running final services on the Cloud VM..."
