...
# --- 1. Clean Up, Deploy Code, and Create Directories ---
Write-Host "[1/4] Cleaning, deploying code, and creating directories..."
# This command now uses 'sudo' to delete the old folder, then clones and creates the necessary storage sub-folders.
...
# First, fix permissions on the newly created keyframes
...
# Third, run the flower-recognizer and wait for it to complete.
...
# Finally, run the dataset-matcher to get the correct result.
